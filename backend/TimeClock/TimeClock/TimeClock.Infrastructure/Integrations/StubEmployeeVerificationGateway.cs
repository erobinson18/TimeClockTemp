...
{
    public Task<VerifiedEmployee?> VerifyByEmployeeNumberAsync(string employeeNumber, CancellationToken ct = default)
    {
        var emp = StubRoster.Employees.FirstOrDefault(e => e.EmployeeNumber == employeeNumber);
